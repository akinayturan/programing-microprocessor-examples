...
main
	...
	RCALL LcdInit
			;	
			;	MesajYaz("Tusa basiniz",0x80); //0x80 Cursorýn baslangýc konumunu belirliyor
	CLRF  msj,0
	MOVLW 128
	RCALL MesajYaz
			;	bekle(800);
...
; 0x000038    8 word(s)  0 % : ayarlar
; 0x000048   17 word(s)  0 % : bekle
; 0x00006A  140 word(s)  0 % : oku_yaz
; 0x0001B4   11 word(s)  0 % : LcdInit
; 0x000198   14 word(s)  0 % : LcdYaz
; 0x000182   11 word(s)  0 % : LcdKomut
; 0x0001CA   30 word(s)  0 % : MesajYaz
; 0x000008    5 word(s)  0 % : int_server
; 0x000012   19 word(s)  0 % : main
; 0x000206   45 word(s)  0 % : _const1

; RAM usage: 15 bytes (15 local), 1521 bytes free
; Maximum call level: 3 (+5 for interrupt)
; Total of 302 code words (1 %)
